function run_map(container, options, data) {
    ...
    var style = {
        CL1: '#888888', // default stroke
        CL2: '#ffffff', // default bg
        CL3: '#f0f0f0', // hover stroke
        CL4: '#0050B2', // hover color
        CL5: '#888888', // inactive stroke
        CL6: '#ffffff', // inactive color
        ST1: 1, ST2: 1
    };
    ...
    let scale = $('.map__scale');
    scale.find('.map__scale-button').bind('click', function () {
    ...
    map.addBubble(bubble[0], {
        ...
        'mousemove': function (mouseCoords) {
            ...
            if (code in data) {
                ...
                bubble.css({
                    'top': mouseCoords.pageY - 30 - bubble.height(),
                    'left': x
                });
            }
        },
...
window.loadAndRunMap = function (map) {
